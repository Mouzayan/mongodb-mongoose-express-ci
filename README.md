[![Coverage Status](https://coveralls.io/repos/github/Mouzayan/mongodb-mongoose-express-ci/badge.svg?branch=master)](https://coveralls.io/github/Mouzayan/mongodb-mongoose-express-ci?branch=master)
...
describe("Projects API", () => {
  it("should show all users", async (done) => {
    ...
    it("should update a project", async (done) => {
      const res = await request(app).put(`/api/projects/${project}`).send({
